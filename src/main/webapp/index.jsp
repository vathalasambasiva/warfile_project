...
<body style="text-align: center">
    ...
    <% if("virtualbox".equals(System.getenv("BOXFUSE_PLATFORM_ID"))) { %>
        ...
        <p style="margin-bottom: 20px;">
            ...
            <strong>boxfuse logs <%= System.getenv("BOXFUSE_INSTANCE_ID") %></strong>
        </p>
        ...
        <p>
            ...
            <strong>boxfuse kill <%= System.getenv("BOXFUSE_INSTANCE_ID") %></strong>
        </p>

        <p>
            Deploy this Image unchanged on AWS:<br/>
            <strong>boxfuse run -env=prod <%= System.getenv("BOXFUSE_APP") %>:<%= System.getenv("BOXFUSE_IMAGE_VERSION") %></strong>
        </p>

    <% } else { %>
        <h2 style="margin-top: 80px">Now it's your turn!</h2>

        <p>Check out <strong><a href="https://github.com/boxfuse/boxfuse-sample-java-war-hello">this app</a></strong> from GitHub, modify it, and give it version 2.<br/>
            You are now ready to fuse and <strong>deploy it with zero downtime</strong> using the commands you already know.</p>

        <p>Alternatively you can go back to the <strong><a href="https://console.boxfuse.com">Boxfuse Console</a></strong>,<br/>
            and simply create your own.</p>

        <p>If you need any help the <strong><a href="http://boxfuse.com/docs">documentation</a></strong> is there for you,<br/>
            or simply shoot us an email at <a href="mailto:support@boxfuse.com">support@boxfuse.com</a></p>
